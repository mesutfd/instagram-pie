...
async def media_info(sessionid: str,
                     pk: int,
                     use_cache: Optional[bool],
                     clients: ClientStorage) -> Media:
...
async def user_medias(sessionid: str,
                      user_id: int,
                      amount: Optional[int],
                      clients: ClientStorage) -> List[Media]:
    """Get a user's media
    """
    cl = clients.get(sessionid)
...
async def media_likers(sessionid: str,
                     media_id: str,
                     clients: ClientStorage) -> List[UserShort]:
    """Get user's likers
    """
    cl = clients.get(sessionid)
