...
async def user_followers(sessionid: str, 
                         user_id: str, 
                         use_cache: Optional[bool], 
                         amount: Optional[int], 
                         clients: ClientStorage) -> Dict[int, UserShort]:
...
async def user_following(sessionid: str, 
                         user_id: str, 
                         use_cache: Optional[bool], 
                         amount: Optional[int], 
                         clients: ClientStorage) -> Dict[int, UserShort]:
...
async def user_info(sessionid: str, 
                    user_id: str, 
                    use_cache: Optional[bool], 
                    clients: ClientStorage) -> User:
...
async def user_info_by_username(sessionid: str, 
                                username: str, 
                                use_cache: Optional[bool], 
                                clients: ClientStorage) -> User:
...
async def user_id_from_username(sessionid: str, 
                                username: str, 
                                clients: ClientStorage) -> int:
...
async def username_from_user_id(sessionid: str, 
                                user_id: int, 
